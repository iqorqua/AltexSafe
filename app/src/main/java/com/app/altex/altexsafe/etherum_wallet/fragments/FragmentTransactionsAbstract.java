...
import com.app.altex.altexsafe.etherum_wallet.activities.RequestEtherActivity;
...
import com.app.altex.altexsafe.etherum_wallet.utils.TransactionAdapter;
...
public abstract class FragmentTransactionsAbstract extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            ...
            rootView.setBackground(getResources().getDrawable( R.drawable.bckg ));
        }
