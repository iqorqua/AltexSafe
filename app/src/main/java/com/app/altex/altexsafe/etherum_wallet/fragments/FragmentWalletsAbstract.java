package com.app.altex.altexsafe.etherum_wallet.fragments;
...
import com.app.altex.altexsafe.MainActivity;
import com.app.altex.altexsafe.R;
import com.app.altex.altexsafe.etherum_wallet.activities.AddressDetailActivity;
import com.app.altex.altexsafe.etherum_wallet.data.CurrencyEntry;
import com.app.altex.altexsafe.etherum_wallet.data.WalletDisplay;
import com.app.altex.altexsafe.etherum_wallet.interfaces.PasswordDialogCallback;
import com.app.altex.altexsafe.etherum_wallet.interfaces.StorableWallet;
import com.app.altex.altexsafe.etherum_wallet.network.EtherscanAPI;
import com.app.altex.altexsafe.etherum_wallet.services.WalletGenService;
import com.app.altex.altexsafe.etherum_wallet.utils.AddressNameConverter;
import com.app.altex.altexsafe.etherum_wallet.utils.Dialogs;
import com.app.altex.altexsafe.etherum_wallet.utils.ExchangeCalculator;
import com.app.altex.altexsafe.etherum_wallet.utils.ResponseParser;
import com.app.altex.altexsafe.etherum_wallet.utils.WalletAdapter;
...
public abstract class FragmentWalletsAbstract extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener {
    ...
    public static final int IMPORT_WALLET = 111;
    ...
    protected FloatingActionButton new_fab;
    protected FloatingActionButton import_fab;

    public abstract void adHandling(View rootView);

    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_wallet_eth, container, false);
        ...
        new_fab = (FloatingActionButton) rootView.findViewById(R.id.new_fab);
        import_fab = (FloatingActionButton) rootView.findViewById(R.id.import_fab);
...
*/
        ...
        new_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setIcon(R.drawable.fab_add);
                final View root = inflater.inflate(R.layout.dialog_view_password, null);
                builder.setView(root);
                        // Add action buttons
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int id) {
                                String np = ((TextInputEditText)root.findViewById(R.id.new_password)).getText().toString();
                                String cp = ((TextInputEditText)root.findViewById(R.id.confirm_password)).getText().toString();
                                if(np.equals(cp) & cp.length()>8){
                                    Intent generatingService = new Intent(getContext(), WalletGenService.class);
                                    generatingService.putExtra("PASSWORD", cp);
                                    ac.startService(generatingService);
                                    ...
                                    IntentFilter intentFilter = new IntentFilter("WALLET_ADDED");
                                    intentFilter.addCategory(Intent.CATEGORY_DEFAULT);
                                    ac.registerReceiver(b, intentFilter);

                                }
                                else {
                                    ac.snackError("Password mismatch or its lengtn less than 9");
                                }
                            }
                     });
                builder.create();
        ...
        import_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new MaterialFilePicker()
                        ...
                        .withRequestCode(IMPORT_WALLET)
                        //.withFilter(Pattern.compile("^UTC(.*)")) // Filtering files and directories by file name using regexp
