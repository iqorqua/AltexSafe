...
import com.app.altex.altexsafe.etherum_wallet.fragments.FragmentDetailOverview;
import com.app.altex.altexsafe.etherum_wallet.fragments.FragmentDetailShare;
import com.app.altex.altexsafe.etherum_wallet.fragments.FragmentTransactions;
...
public class AddressDetailActivity extends SecureAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.getTabAt(1).setIcon(R.drawable.wallet30);
        tabLayout.getTabAt(2).setIcon(R.drawable.ic_format_line_spacing_black_24dp);
