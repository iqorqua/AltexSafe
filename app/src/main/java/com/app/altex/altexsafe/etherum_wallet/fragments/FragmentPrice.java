...
import com.app.altex.altexsafe.etherum_wallet.interfaces.NetworkUpdateListener;
...
import com.app.altex.altexsafe.etherum_wallet.views.DontShowNegativeFormatter;
import com.app.altex.altexsafe.etherum_wallet.views.HourXFormatter;
import com.app.altex.altexsafe.etherum_wallet.views.WeekXFormatter;
import com.app.altex.altexsafe.etherum_wallet.views.YearXFormatter;
...
public class FragmentPrice extends Fragment {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                ac.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            onItemsLoadComplete();
                            ac.snackError(getString(R.string.err_no_con));
                        } catch(Exception e){}
                    }
                });
            }
    ...
    public void updateExchangeRates() {
        try {
            refreshChart = false;
            ExchangeCalculator.getInstance().updateExchangeRates(ac != null ? ac.getPreferences().getString("maincurrency", "USD") : "USD", (NetworkUpdateListener) ac);
            onItemsLoadComplete();
        } catch (IOException e) {
            e.printStackTrace();
        }
