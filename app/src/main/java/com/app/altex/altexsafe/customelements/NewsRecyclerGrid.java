...
public class NewsRecyclerGrid extends RecyclerView.Adapter<NewsRecyclerGrid.ViewHolder> {
    ...
    public NewsRecyclerGrid(Context context, ImageGridItem[] data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.get().load(mData[position].getImage()).into(holder.image);
    }
