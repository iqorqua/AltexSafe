package com.app.altex.altexsafe.etherum_wallet.utils;

import android.content.Context;
import android.util.Log;

import com.app.altex.altexsafe.etherum_wallet.data.TokenDisplay;
import com.app.altex.altexsafe.etherum_wallet.data.TransactionDisplay;
    ...
    public static ArrayList<TransactionDisplay> parseTransactions(String response, String walletname, String address, byte type) {
        try {
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                if (data.getJSONObject(i).getString("value").equals("0") && ! false)//Settings.showTransactionsWithZero)
